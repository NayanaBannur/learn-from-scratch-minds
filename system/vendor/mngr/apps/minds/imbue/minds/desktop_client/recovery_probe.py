...
def _supervisorctl_status_inner_command() -> str:
    ...
    Pointed at the repo-root config (``-c /home/user/workspace/supervisord.conf``)
    ...
    """
    return "supervisorctl -c /home/user/workspace/supervisord.conf status system_interface"
